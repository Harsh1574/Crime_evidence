...
export function cidFromSha256(sha256Hex) {
...
export function looksLikeCid(value) {
...
export async function addBuffer(data, fileName = "data") {
    if (getIpfsMode() === "kubo") {
...
export async function addFile(filePath, sha256Hex) {
    if (getIpfsMode() === "kubo") {
        const form = new FormData();
